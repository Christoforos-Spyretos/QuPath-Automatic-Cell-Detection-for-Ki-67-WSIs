...
// Ensure the file exists in the writable output directory before reading or writing
def filePath = buildFilePath(out_dir, 'Area_Det.txt')
def f = new File(filePath)
if (!f.exists()) {
    f.createNewFile()
    println "Created missing file: ${filePath}"
}
