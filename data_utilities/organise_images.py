...
KI67_names = ["KI-67", "ki-67", "Ki-67", "KI67", "Ki067_A2", "Ki-62", "Ki-57", "Ki67", "Ki-67_B1", "H_and_E_Ki-67", "KI-67_A1", "KI-67_A2",
         ...
         "Ki-67_(D)", "Ki-67_(A)", "KI-67_BLOCK_2", "KI-67_BLOCK_1", "Ki-67_C9", "Ki-67_(A1)", "10412_1B_KI67", "Ki-67_C", "Ki67_(D5)", "Ki-67_B", 
         "Ki-67_A1", "Ki-67_C2", "Ki-67_A2", "1_B_Ki67"]
...
session_ids_from_df = df_KI67['slide_id'].values
session_ids_from_df = [session_id.split("___")[1] for session_id in session_ids_from_df]
...
for subject_id in df_KI67['case_id']:
    ...
    if os.path.exists(path_to_session):
        ...
        for session_id in sessions_ids:
            ...
            if session_id in session_ids_from_df:
