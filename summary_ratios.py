...
parser.add_argument('--area', type=str, default=False, help='Directory to Area.txt which is saved under the Results folder.')
...
if not os.path.isfile(area):
    raise FileNotFoundError(f"The specified Area.txt file does not exist: {area}")
...
annotation_df = pd.read_csv(area,names=['name', 'detections', 'area'],delimiter=";",index_col=False)
